...
console.log(createMenuItem('smoothie', 3, 'drink'));
...
//   const newReview = {name: 'Daniela', rating: 5, feedback: 'great eats!'};
...
console.log(addReview(reviews, 'Renee', '5', 'this place rocks!'));
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 6: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
function getReviewByIndex(array, desiredI) {
  return `${array[desiredI].name} gave the restaurant a ${array[desiredI].rating} star review, and their feedback was: ${array[desiredI].feedback}` 
